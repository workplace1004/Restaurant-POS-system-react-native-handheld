      ...
      <View className="flex-1 flex flex-col min-w-0 p-4 bg-pos-bg py-2">
        <View className="p-1 flex-1">
          {!layoutForCategory ? (
            ...
            <View className="w-full flex flex-row flex-wrap content-start gap-1 text-lg">
                    ...
                    {items.map((sp) => (
                      ...
                      >
                        ...
                        <View className="flex flex-col items-center justify-center">
                          ...
                          <Text className="text-xs text-white">€ {Number(sp.price ?? 0).toFixed(2)}</Text>
                        </View>
                      </Pressable>
                    ))}
                  </View>
